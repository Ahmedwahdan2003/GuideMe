...
Home::Home(QWidget *parent) : QMainWindow(parent), ui(new Ui::Home), graph(new Graph())
{
    ...
    if (!graph->readGraphFile("C:\\Users\\RAWAN\\Desktop\\GuideMe\\GuideMe\\src\\Graph.txt")) {
    ...
    QString imagePath ="C:\\Users\\RAWAN\\Desktop\\GuideMe\\GuideMe\\src\\space_back2";
...
Home::~Home()
{
    graph->writeGraphToFile("C:\\Users\\RAWAN\\Desktop\\GuideMe\\GuideMe\\src\\Graph.txt");
    delete graph;
    delete ui;
